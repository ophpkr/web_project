...
<h1 class="center-align">S'inscrire à la compétition</h1>
          ...
          <div class="row">
            <form method="POST" action = "../Controller/cont_registration_contestant.php" class="col s12 m5 l5 offset-m1 offset-l1">
              <div class="row">
                <div class="input-field s12 m5 l8 offset-m6 offset-l6">
              ...
              <div class="row">
                ...
                <div class="row">
                <div class="input-field s12 m5 l8 offset-m6 offset-l6" name="phone">
                  <i class="material-icons prefix">contact_phone</i> 
                  <input placeholder="tel" type="text" class="validate">
                </div>
                </div>
                <div class="row">
                <div class= "s12 m5 l8 offset-m6 offset-l6">
              ...
              <div class="row">
              <div>
                <button class = "waves-effect waves-light btn orange lighten-1 offset_m1 offset-l1 offset-s2" type="submit">M'inscrire</button>
              </div>
              </div>
            </form>
          </div>

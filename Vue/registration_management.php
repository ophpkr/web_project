...
<div class= "row">
    ...
    { ?>
                ...
                <tbody>
                    ...
                    <tr>
                    <td><a class="waves-effect waves-light" href="<?php echo '#modrnp' . $numRegNotPaid[$i]; ?>"><i class="material-icons">delete</i></a></td>
                    ...
                    <td><a class="waves-effect waves-light" href="<?php echo '#modseecontnp' . $numRegNotPaid[$i]; ?>"><i class="material-icons">description</i></a></td>
                    </tr>
    ...
    <div>
            <div>               
                ...
                <tbody>
                    ...
                    {?>
                    <tr>
                    <td><a class="waves-effect waves-light" href="<?php echo '#modrnap' . $numRegNotAP[$i]; ?>"><i class="material-icons">delete</i></a></td>
